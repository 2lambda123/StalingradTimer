...
//                                .cornerRadius(5)
            ...
            if timerManager.showTimePicker && timerManager.settingsMode == .rounds {
                TimePickerForm(seconds: Float(timerManager.usersRounds), minuteSelection: 0, secondSelection: timerManager.usersRounds, timePickerText: "Раунды")
            }
